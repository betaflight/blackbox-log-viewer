...
function HeaderDialog(dialog, onSave) {
	...
	**/
    ...
    var parameterVersion = [
            ...
            {name:'vbat_pid_compensation'       , type:FIRMWARE_TYPE_BETAFLIGHT,  min:'2.8.0', max:'4.2.9'},
            ...
            {name:'dterm_rpm_notch_harmonics'   , type:FIRMWARE_TYPE_BETAFLIGHT,  min:'4.1.0', max:'4.2.9'},
            {name:'dterm_rpm_notch_q'           , type:FIRMWARE_TYPE_BETAFLIGHT,  min:'4.1.0', max:'4.2.9'},
            {name:'dterm_rpm_notch_min'         , type:FIRMWARE_TYPE_BETAFLIGHT,  min:'4.1.0', max:'4.2.9'},
            ...
            {name:'dyn_notch_range'             , type:FIRMWARE_TYPE_BETAFLIGHT,  min:'4.1.0', max:'4.1.9'},
