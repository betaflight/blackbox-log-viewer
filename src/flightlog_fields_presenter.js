...
const DEBUG_FRIENDLY_FIELD_NAMES_INITIAL = {
  ...
  // Rotorflight firmware < 4.5.0 layout; superseded by the version-gated override added in
  // adjustDebugDefsList() for firmware >= 4.5.0.
  YAW_PRECOMP: {
  ...
  switch (fieldName) {
    ...
    case 'baroAlt':
      return toFriendly
        ...
        : (value * 100) /
            FlightLogFieldPresenter.decodeAltitudeLogToChart(1.0, userSettings.altitudeUnits)
