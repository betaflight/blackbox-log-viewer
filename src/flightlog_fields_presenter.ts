  ...
  switch (fieldName) {
    ...
    case "gyroUnfilt[2]":
      return toFriendly
        ...
        : (value * highResolutionScale) /
            flightLog.gyroRawToDegreesPerSecond(1);
    ...
    case "axisS[2]":
      return toFriendly
        ...
        : value / flightLog.getPIDPercentage(1);
...
FlightLogFieldPresenter.ConvertDebugFieldValue = function (
  ...
  if (flightLog) {
    ...
    switch (debugModeName) {
      ...
      case "GHST":
        // debug: 0 CRC errors, 1 unknown frames, 2 RSSI, 3 LQ 0-100
        return value;
      case "GHST_MSP":
        switch (fieldName) {
          // debug 0 is msp frame count
      ...
      case "RX_EXPRESSLRS_SPI":
        // debug: 0 lost-connection count, 1 RSSI, 2 SNR, 3 uplink LQ %
        return value;
      case "RX_EXPRESSLRS_PHASELOCK":
        // debug: 0/1 phase offset us, 2 frequency offset ticks, 3 phase shift us
        return value;
      case "GPS_RESCUE_THROTTLE_PID":
        switch (fieldName) {
          case "debug[0]": // Throttle P added uS
