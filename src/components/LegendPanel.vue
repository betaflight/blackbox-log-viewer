<template>
  <div class="log-graph-config">
    <h2 id="legend_title">Legend
      <span class="log-close-legend-dialog" title="Hide the legend"></span>
    </h2>
    <div class="log-index"></div>
    <div class="log-graph-legend">
    </div>

    <div class="flex gap-0.5 override-button-group" role="group">
      <button type="button" class="p-1 leading-none bg-transparent text-neutral-400 hover:text-white cursor-pointer toggle-expo" title="Expo On/Off">
      ...
      <button type="button" class="p-1 leading-none bg-transparent text-neutral-400 hover:text-white cursor-pointer toggle-smoothing" title="Smoothing On/Off">
        <svg width="24" height="24" viewBox="0 0 8.467 8.467">
      ...
      <button type="button" class="p-1 leading-none bg-transparent text-neutral-400 hover:text-white cursor-pointer toggle-grid" title="Grid On/Off">
        <svg width="24" height="24" viewBox="0 0 8.467 8.467">
          <path fill="none" stroke="#FFF" stroke-linecap="round" stroke-width=".5" d="M0 4.233s2.117 5.292 4.233 0c2.117-5.291 4.234 0 4.234 0"/>
