...
export const FlightLogEvent = makeReadOnly({
  ...
  GOVERNOR_STATE: 50, // Rotorflight
  RESCUE_STATE: 51, // Rotorflight
  AIRBORNE_STATE: 52, // Rotorflight
...
export let FLIGHT_LOG_FEATURES = makeReadOnly([
  'RX_PPM',
  'VBAT',
  'INFLIGHT_ACC_CAL',
  'RX_SERIAL',
...
export let FAST_PROTOCOL = makeReadOnly([
  'PWM',
  'ONESHOT125',
  'ONESHOT42',
  'MULTISHOT',
...
export let FLIGHT_LOG_GOVSTATES = []
...
export const FLIGHT_LOG_RESCUE_STATES = makeReadOnly([
  'OFF',
  'PULLUP',
  'FLIP',
  'CLIMB',
