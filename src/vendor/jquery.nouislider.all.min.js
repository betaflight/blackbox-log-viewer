...
(!(function () {
  ...
  (function (a) {
    ...
    function F(b) {
      var c,
        d = { margin: 0, limit: 0, animate: !0, format: Y };
      return (
        (c = {
          step: { r: !1, t: t },
          start: { r: !0, t: v },
    ...
    function I(b, c) {
      ...
      return (
        b && e.reverse(),
        d.children().addClass(X[3] + " " + X[3] + e[c]),
        d
      );
    }
    function J(a, b, c) {
    ...
    function M(b, c, d) {
      ...
      function l(b) {
        ...
        D[0].linkAPI &&
          D[0].linkAPI[b] &&
          D[0].linkAPI[b].change(I[c], C[c].children(), D);
      }
      function m(b, d) {
        var e = a.inArray(b, M);
        return (
          d && d.appendTo(C[e].children()),
      ...
      function q(b) {
        (a("." + X[15]).removeClass(X[15]),
          b.cursor && a("body").css("cursor", "").off(V),
          T.off(V),
          D.removeClass(X[12]),
          i(["set", "change"]));
      }
      ...
      function s(b) {
        ...
        (b.stopPropagation(),
          ...
          (h = h / 2 > g || 1 === C.length ? 0 : 1),
          (g -= B.offset()[c.style]),
          (d = (100 * g) / e()),
          c.events.snap || f(D, X[14], 300),
          u(C[h], d),
          i(["slide", "set", "change"]),
          c.events.snap && r(b, { handles: [C[h]] }));
      }
      function t(a) {
        var b, c;
        if (!a.fixed)
          for (b = 0; b < C.length; b += 1)
            o(W.start, C[b].children(), r, { handles: [C[b]] });
        (a.tap && o(W.start, B, s, { handles: C }),
          a.drag &&
            ((c = B.find("." + X[7]).addClass(X[10])),
            a.fixed && (c = c.add(B.children().not(c).children())),
            o(W.start, c, r, { handles: C })));
      }
      function u(a, b, d) {
        var e = a[0] !== C[0][0] ? 1 : 0,
          f = E[0] + c.margin,
        ...
        for (c.limit && (a += 1), d = 0; a > d; d += 1)
          ((e = d % 2),
            ...
            null !== f &&
              ...
              (f === !1 ||
                isNaN(f) ||
                u(C[e], F.toStepping(f), d === 3 - c.dir) === !1) &&
                l(M[e])));
      }
      function w(a) {
      ...
      function y() {
        return (
          a(this).off(V).removeClass(X.join(" ")).empty(),
