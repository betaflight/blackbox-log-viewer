/**
 * STEP 12 — Scientific Gate Calibration
 *
...
import type { IngestedData, MagGaussEntry, GpsEntry } from './flightIngestion.js';
...
describeIntegration('STEP 12: Gate Calibration', () => {
